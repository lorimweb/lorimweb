...
Desenvolvedor Full-Stack com foco em aplicações web e mobile, utilizando Java (Spring), JavaScript, TypeScript, ReactJS e Angular para construir soluções escaláveis e de alto desempenho. Experiência em arquitetura front-end e back-end, com habilidades em Node.js, desenvolvimento mobile com React Native, e boas práticas de código, otimização de processos e integração de sistemas.
